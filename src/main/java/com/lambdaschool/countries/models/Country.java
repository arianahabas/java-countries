...
@Entity // converts into a bean
@Table(name = "countries") //makes this class a table

public class Country {

  @Id
  @GeneratedValue(strategy = GenerationType.AUTO)
  //fields - will become columns in the database

    private long countryid; // also used in CountryRepository (next to CrudRepository)
    private String name;
